...
def predict_sign_language_sentence(video_path, model_path='best_model.pth', label_mapping_path='dataset/label_mapping.pkl', device=None, window_size=32, stride=8, prediction_method='consecutive', confidence_threshold=0.0, block_durations=None, target_fps=None, block_duration_for_summary=1, show=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="models/best_model.pth", help="Path to the trained model file.")
